...
<head>
    ...
    $(document).ready(function () {
        ...
        function validateImages() {
              var imgs = $("#article_image").val();

              var exts = ['jpg','jpeg','png','gif', 'bmp'];
              // split file name at dot
              var get_ext = imgs.split('.');
    ...
    var addArticles = function(){
      ...
      article_image = article_form.elements["article_image"].value;
      author_name = article_form.elements["art_author"].value;
...
<!--                                     <li><a href="javascript:;">  Profile</a>
            ...
            <div class="right_col" role="main">
               ...
               <!--  <footer>
                    <div class="">
                        <p class="pull-right">lczlkhk<a>lkjlkjl</a>. |
                            <span class="lead"> <i class="fa fa-paw"></i> lkhhkjlcj</span>
                        </p>
                    </div>
                    <div class="clearfix"></div>
                </footer> -->
