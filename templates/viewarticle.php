                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12" style="padding: 0;">
                                              <div class="messages">
                                                        <div class="message_wrapper">
                                                            <h4 class="art_heading">Article Title</h4>
                                                            <p>Category : <span id="art_cat"></span></p>
                                                            <p>Author : <span id="art_author"></span></p
                                                            <p>Published On : <span id="art_pub"></span></p>
                                                            <blockquote class="message" id="article_content">Category Description.</blockquote>

                                                        </div>
                                                        <div class="x_content">
                                                          <div class="bs-example" data-example-id="simple-jumbotron">
                                                              <div class="col-md-12">
                                                                <img id="art_img" class="img-responsive" src="" alt="Article image">
                                                              </div>
                                                          </div>
                                                      </div>
                                                </div>
                                ...
                                <div class="x_content">
                                    ...
                                    <div class="form-group">
                                            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-0">
                                                <a href="/magazine/manage-article" class="btn btn-success"> << Back</a>
                                            </div>
                                        </div>
